...
func BenchmarkMatVecTI2SI8SFFNDown(b *testing.B) {
	// Typical llama/bitnet FFN-down shape for hidden=1024, ffn=4096:
	// ffn_down weights are [rows=4096, cols=1024] with transposed matvec.
