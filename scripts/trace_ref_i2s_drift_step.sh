...
grep -E '^TOPK step='"$STEP"'|^TOKEN step='"$STEP"'|^DEBUG name=result_norm|^DEBUG_VALUES name=(result_norm|ffn_sub_norm|ffn_out)-|^DEBUG name=(attn_o_out|ffn_gate|ffn_up|ffn_out|ffn_down)-' "$OUT" || true
