...
grep -E '^TOPK step='"$STEP"'|^TOKEN step='"$STEP"'|^DEBUG name=result_norm|^DEBUG_VALUES name=(result_norm|Qcur|Kcur|Vcur|attn_sub_norm|attn_o_out|ffn_inp|ffn_sub_norm|ffn_out|l_out)-|^DEBUG name=(attn_o_out|ffn_gate|ffn_up|ffn_out|ffn_down|l_out)-' "$OUT" || true
